...
CREATE TABLE `tbl_user` (
  ...
  `user_lastlog` varchar(100) NOT NULL,
  `user_failed` varchar(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_lname`, `user_name`, `user_pass`, `user_level`, `user_ip`, `user_lastlog`, `user_failed`) VALUES
(1, 'Justin William', 'Brunner', 'jbrunner', 'password', '1', '::1', '', '0'),
(2, 'wei', 'chen', 'wchen', '123', '1', '::1', '2017-01-26 11:38:03', '0'),
(3, '12', 'fadsfsaf', 'dsafdasf', 'asfasdf', '0', '0', '0', '1'),
(4, 'fdsfafda', 'fdsafasdfaf', 'adsffdasf', '121413', '1', '0', '0', '0'),
(5, 'hello', 'hello', 'hello', '123', '1', '0', '0', '0');
...
--
ALTER TABLE `tbl_user`
  MODIFY `user_id` smallint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
